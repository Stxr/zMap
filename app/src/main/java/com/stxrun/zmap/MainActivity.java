...
public class MainActivity extends AppCompatActivity implements AMap.OnMapClickListener, AMapLocationListener, LocationSource, RouteSearch.OnRouteSearchListener, AMapNaviListener {
    //显示地图需要的变量
